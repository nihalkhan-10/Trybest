...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Mohin-404/Approve/blob/main/Approved.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801983856000?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
os.system('espeak -a 300 " Welcome,   to,  MOHIN,  V I P,  Tools"')
def back():
	login()
...
while attemps < 12345677901:
    ...
    if username == 'FUCK' and password == 'YOU':
...
def menu():
    ...
    print('\x1b[38;5;50║══=================')
    MOHINj = input('\x1b\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mCHOOSE: ')
    if MOHINj in ['111']:
        login()
        dump_massal()
    elif MOHINj in ['1']:
